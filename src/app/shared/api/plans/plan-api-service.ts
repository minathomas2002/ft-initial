...
export class PlanApiService {
  ...
  getActiveEmployeesForPlans(
    ...
    return this.baseHttpService.get<IAssignReassignActiveEmployee, string>(
      API_ENDPOINTS.plans.getActiveEmployeesWithPlans + planId,
    );
  }

  assignEmployeeToPlan(req: IAssignRequest): Observable<IBaseApiResponse<boolean>> {
    return this.baseHttpService.post<boolean, IAssignRequest, unknown>(
      API_ENDPOINTS.plans.assign,
      req,
    );
  }
  ...
  reassignEmployeeToPlan(req: IAssignRequest): Observable<IBaseApiResponse<boolean>> {
    return this.baseHttpService.post<boolean, IAssignRequest, unknown>(
      API_ENDPOINTS.plans.reassign,
      req,
    );
  }

  saveAsDraftProductLocalizationPlan(req: FormData): Observable<IBaseApiResponse<boolean>> {
    return this.baseHttpService.post<boolean, FormData, unknown>(
      API_ENDPOINTS.plans.saveAsDraftProductLocalizationPlan,
      req,
    );
  }
  ...
  saveAsDraftServiceLocalizationPlan(req: FormData): Observable<IBaseApiResponse<boolean>> {
    return this.baseHttpService.post<boolean, FormData, unknown>(
      API_ENDPOINTS.plans.saveAsDraftServiceLocalizationPlan,
      req,
    );
  }
  ...
  submitProductLocalizationPlan(req: FormData): Observable<IBaseApiResponse<boolean>> {
    return this.baseHttpService.post<boolean, FormData, unknown>(
      API_ENDPOINTS.plans.submitProductLocalizationPlan,
      req,
    );
  }
  ...
  submitServiceLocalizationPlan(req: FormData): Observable<IBaseApiResponse<boolean>> {
    return this.baseHttpService.post<boolean, FormData, unknown>(
      API_ENDPOINTS.plans.submitServiceLocalizationPlan,
      req,
    );
  }
  ...
  reSubmitProductPlan(req: FormData): Observable<IBaseApiResponse<boolean>> {
    return this.baseHttpService.post<boolean, FormData, unknown>(
      API_ENDPOINTS.plans.reSubmitProductPlan,
      req,
    );
  }
  ...
  reSubmitServicePlan(req: FormData): Observable<IBaseApiResponse<boolean>> {
    return this.baseHttpService.post<boolean, FormData, unknown>(
      API_ENDPOINTS.plans.reSubmitServicePlan,
      req,
    );
  }

  internalApprovePlanStatus(req: {
    planId: string;
    status: EemployeePlanAction;
    reason: string | undefined;
    approvalSignature?: string;
  }): Observable<IBaseApiResponse<boolean>> {
    return this.baseHttpService.post<
      ...
      unknown
    >(API_ENDPOINTS.plans.internalApprovePlan, req);
  }

  internalRejectPlanStatus(req: {
    planId: string;
    status: EemployeePlanAction;
    reason: string | undefined;
  }): Observable<IBaseApiResponse<boolean>> {
    return this.baseHttpService.post<
      boolean,
      { planId: string; status: EemployeePlanAction; reason: string | undefined },
      unknown
    >(API_ENDPOINTS.plans.internalRejectPlan, req);
  }

  DvRejectionAcknowledge(req: {
    planId: string;
    acknowledgeNote: string | undefined;
  }): Observable<IBaseApiResponse<boolean>> {
    return this.baseHttpService.post<
      boolean,
      { planId: string; acknowledgeNote: string | undefined },
      unknown
    >(API_ENDPOINTS.plans.dvAcknowledgeRejection, req);
  }

  getProductPlan(req: { planId: string }): Observable<IBaseApiResponse<IProductPlanResponse>> {
    return this.baseHttpService.post<IProductPlanResponse, { planId: string }, unknown>(
      API_ENDPOINTS.plans.getProductPlan,
      req,
    );
  }
  ...
  getServicePlan(req: {
    ...
    return this.baseHttpService.post<IServiceLocalizationPlanResponse, { planId: string }, unknown>(
      API_ENDPOINTS.plans.getServicePlan,
      req,
    );
  }

  getTimeLine(req: { planId: string }): Observable<IBaseApiResponse<ITimeLineResponse[]>> {
    return this.baseHttpService.post<ITimeLineResponse[], { planId: string }, unknown>(
      API_ENDPOINTS.plans.getTimelinePlan,
      req,
    );
  }
  ...
  generateProductPlanPdf(planId: string): Observable<{ blob: Blob; filename: string }> {
    return this.http
      .get(
        `${API_ENDPOINTS.baseUrl}/${API_ENDPOINTS.plans.generateProductPlanPdf}${planId}&clientSideDateTime=${this.getCurrentDateTime()}`,
        {
          responseType: 'blob',
          observe: 'response',
        },
  ...
  generateServicePlanPdf(planId: string): Observable<{ blob: Blob; filename: string }> {
    return this.http
      .get(
        `${API_ENDPOINTS.baseUrl}/${API_ENDPOINTS.plans.generateServicePlanPdf}${planId}&clientSideDateTime=${this.getCurrentDateTime()}`,
        {
          responseType: 'blob',
          observe: 'response',
        },
  ...
  sendPlanBackToInvestor(req: ReviewPlanRequest): Observable<IBaseApiResponse<boolean>> {
    return this.baseHttpService.post<boolean, ReviewPlanRequest, unknown>(
      API_ENDPOINTS.plans.reviewPlan,
      req,
    );
  }
  getInvestorPlans(
  ...
  getPlanComment(planId: string): Observable<IBaseApiResponse<IPlanCommentResponse>> {
    return this.baseHttpService.post<IPlanCommentResponse, { planId: string }, unknown>(
      API_ENDPOINTS.plans.getPlanComment,
      { planId },
    );
  }

  deleteDraftPlan(planId: string): Observable<IBaseApiResponse<boolean>> {
    return this.baseHttpService.post<boolean, { planId: string }, unknown>(
      API_ENDPOINTS.plans.deleteDraftPlan,
      { planId },
    );
  }
